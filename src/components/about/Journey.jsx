      ...
      <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
        <div className="lg:flex gap-5 items-start w-full">
          ...
          <div className="flex flex-col gap-5">
            <h4 className="text-2xl font-semibold dark:text-white">Mission</h4>
            <p className="text-lg dark:text-secondary-dark">
              ...
              accessible platform that drives AI transformation across
              industries, helping businesses unlock the full potential of their
              data.
            </p>
          </div>
        </div>
        ...
        <div className="lg:flex gap-5 items-start w-full">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-lg dark:text-secondary-dark">
              ...
              that solve real business problems in a fast, efficient, and
              scalable manner. As businesses continue to evolve, we aim to be at
              the forefront of AI innovation, helping our clients leverage the
